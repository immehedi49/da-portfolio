  ...
  return (
    <div className="footer">
        ...
        <div className="footer-social">
          ...
          <div className="footer-git">
            <div className="git-img">
              <a
                href="https://github.com/immehedi49"
                target="_blank"
            ...
            <div>
              ...
              <a className="git-link" href="https://github.com/immehedi49">
                github.com/immehedi49
              </a>
            </div>
          </div>
          ...
          <div className="footer-linked">
            <div className="linked-img">
              <a
                href="https://www.linkedin.com/in/mehedihasan49"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="footer-copy">
        Copyright © 2026 <span>Md. Mehedi Hasan</span>
      </div>
    </div>
  );
}
