export default function Home() {
  return (
    <div className="home">
      ...
      <div className="intro">
        I am a <span className="span">Data Analyst</span> focused on
        transforming raw data into meaningful insights that drive informed
        decisions. I specialize in analyzing trends, building clear
        visualizations, and turning complex information into actionable
        strategies that help businesses grow smarter and faster.
      </div>
